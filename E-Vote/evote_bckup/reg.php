...
<title>Validate</title>
 ...
 <?php
   echo "</br></br>";
   if(isset($_POST['name']) and isset($_POST['adno']) and isset($_POST['voteid']) and isset($_POST['phno']) and isset($_POST['wardno']) and isset($_POST['area']) and isset($_POST['footno']) ) and die();
...
if($con){
  ...
  if($_SERVER['REQUEST_METHOD']=='POST' or die("Get Not Allowed"))
  {
